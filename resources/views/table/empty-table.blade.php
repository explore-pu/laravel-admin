<tr>
    <td colspan="{{ $table->visibleColumns()->count() }}" class="empty-table" style="padding: 100px;text-align: center;color: #989898">
        <svg t="1562312016538" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="2076" width="128" height="128" style="fill: #989898;">
