define(['jquery', 'NProgress', 'sweetalert2'], function($, NProgress, Swal) {
    ...
    $.ajaxPrefilter(function (options, originalOptions, jqXHR) {
        ...
        else if ((options.type && options.type.toLowerCase() === 'post') || (originalOptions.type && originalOptions.type.toLowerCase() === 'post')) {
        ...
        else if ((options.type && options.type.toLowerCase() === 'put') || (originalOptions.type && originalOptions.type.toLowerCase() === 'put')) {
            if (originalOptions.data instanceof FormData) {
                originalOptions.data.append('_token', $.admin.getToken());
                options.data = originalOptions.data;
            } else {
