...
class Table
{
     ...
     *
     * @var \Elegance\Admin\Table\Model|\Illuminate\Database\Eloquent\Builder
     */
    protected $model;
...
HTML;
    ...
    protected function variables()
    {
        $this->variables = array_merge($this->variables, [
            'table'       => $this,
            'table_class' => 'table table-hover text-nowrap table-table',
        ]);
